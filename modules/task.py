...
# Load configuration for the 'tasks' variable from config file
...
class Task:
    def __init__(self, task_id, position):
        ...
        self.radius = self.amount / config['simulation']['task_visualisation_factor']       # Value divided by Scaling factor for visualisation purposes
